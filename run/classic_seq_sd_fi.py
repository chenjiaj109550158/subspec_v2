...
from specdecodes.models.draft_models.classic_seq_sd_fi import ClassicSeqFiDraftModel
from specdecodes.models.generators.classic_seq_sd_fi import ClassicSeqFiGenerator
...
class ClassicSeqFiBuilder(GeneratorPipelineBuilder):
    def __init__(self):
        super().__init__()
        # Base configurations.
    ...
    def load_draft_model(self, target_model, tokenizer, draft_model_path):
        draft_model = ClassicSeqFiDraftModel.from_pretrained(
            draft_model_path,
    ...
    def load_generator(self, target_model, tokenizer, draft_model=None):
        generator = ClassicSeqFiGenerator(
            target_model=target_model,
            tokenizer=tokenizer,
